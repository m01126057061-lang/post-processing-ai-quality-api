...
class EvaluateRequest(BaseModel):
    ...
    context: str | None = Field(None, description="Original prompt/context (used by relevance scorer).")
...
class FilterRequest(BaseModel):
    ...
    context: str | None = Field(None, description="Shared prompt/context for all texts.")
    metrics: list[str] = Field(
        default=["coherence", "relevance", "fluency"],
...
class PipelineStepConfig(BaseModel):
    ...
    operation: Literal["strip", "lowercase", "truncate"] | None = Field(
